...
> 📸 *Capture à insérer : `screenshots/aws-vpc-resource-map.png` (carte des ressources VPC dans la console AWS).*
...
> 📸 *Capture : `screenshots/github-actions-green.png` (pipeline verte, les jobs visibles).*
...
> 📸 *Captures : `screenshots/github-security-trivy.png` (alertes SARIF), `screenshots/codeql-results.png`.*
...
> 📸 *Captures : `screenshots/grafana-dashboard.png`, `screenshots/cloudwatch-logs.png`.*
...
> 📸 *Capture : `screenshots/ecs-service-tasks.png` (2 tâches RUNNING sur 2 AZ).*
...
> 📸 *Capture : `screenshots/app-prod.png` (l'application affichant les jeux, URL S3 visible).*
...
> 📸 *Capture : `screenshots/security-groups.png` (règles des 3 SG).*
...
## 6. Annexe — captures à inclure
À placer dans `docs/screenshots/` et vérifier que chaque image du rapport s'affiche :
- [ ] `aws-vpc-resource-map.png` — carte des ressources VPC
- [ ] `github-actions-green.png` — pipeline CI verte
- [ ] `github-security-trivy.png` — alertes Trivy (SARIF)
- [ ] `codeql-results.png` — résultats CodeQL
- [ ] `ecs-service-tasks.png` — 2 tâches ECS RUNNING (2 AZ)
- [ ] `app-prod.png` — application en production (URL S3)
- [ ] `grafana-dashboard.png` — dashboard Grafana
- [ ] `cloudwatch-logs.png` — logs ECS dans CloudWatch
- [ ] `security-groups.png` — règles des Security Groups
- [ ] `gitlab-mirror.png` — dépôt GitLab à jour (preuve du mirroring)
